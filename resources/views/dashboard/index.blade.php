...
<body>
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              {{-- <img class="img-xs rounded-circle" loading="eager" src="{{ Auth::user()->img }}" alt="Profile image"> </a> --}}
              <div id="avatar">
  ...
  <script>
      ...
      profileImage.src = "{{ Auth::user()->img }}";
      profileImage.className = "img-xs rounded-circle";
